...
Su objetivo es desplazar hacía el archivo de Historia de Mantenimiento, las **OT** que estando Cerradas, residen todavía en el archivo de Ordenes de Trabajo.   Tales Órdenes cerradas se reconocen por tener en el visor de Órdenes de Trabajo, en la columna **“** Estado  **”** un valor igual a „C’ o  ‘K  ’, Cerradas, Canceladas, respectivamente, que se obtiene al ejecutar el proceso de cierre.
...
Esta opción permite la exportación de los registros de **OT**, SS y PA que aparecen en el visor, totales o provenientes de un subgrupo, a un archivo de Excel que se descarga automáticamente en la estación cliente donde se ejecutó el proceso.
