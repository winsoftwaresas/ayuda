...
![Ventana menú de mas informacion](../../assets/images/cap01/chp01_img09.png)
...
Después de seleccionar el tipo de registro se procede a seleccionar el reporte que se desea imprimir; para esto se debe pulsar el botón [Imprimir](#0){: .btn.white}. De esta manera se abre una ventana visor para formatos PDF, que muestra el reporte seleccionado. Desde esta ventana es posible guardar el reporte y exportarlo a Excel.
...
| [Cancelar](#0){: .btn.blue} | Con este botón se cancela cualquier transacción que se esté realizando. |
...
| [Cancelar](#0){: .btn.gray} | Este botón permite Cancelar la acción que se está ejecutando. Normalmente aparece un mensaje para confirmar la cancelación. |
...
| <span class="mdi mdi-magnify icon gray"></span> | **Ir A**<br />Con este botón se puede buscar un Activo digitando exactamente el código del Activo definido en el módulo de Activos. |
...
| <span class="mdi mdi-message-alert icon gray"></span> | **Indicadores**<br />Con este botón se muestra el significado de los colores mostrados en la columna de Indicadores de los módulos de Infraestructura, Activos, Almacén de Repuestos, PM, SS, PA, OT e HI. |
...
![Ventana acceso directo](../../assets/images/cap01/chp01_img61.png)
