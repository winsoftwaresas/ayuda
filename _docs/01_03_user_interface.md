...
| <a class="btn blue">ELIMINAR <span class="mdi mdi-delete"></span></a>  | Se utiliza para borrar un registro de la base de datos y registrar simultáneamente el cambio en la ventana Visor.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
