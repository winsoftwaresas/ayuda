---
title: Transacciones
subtitle:  Esta opción permite la exportación de los Documentos de Kárdex que aparecen en el visor, totales o provenientes de un subgrupo, a un archivo de Excel que se descarga automáticamente en la estación cliente donde se ejecutó el proceso.
tags: [setup]
author: win
order: 05_04
---
