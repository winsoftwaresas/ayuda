...
Este recuadro hace referencia a los datos del Usuario solicitante necesarios para la creación del mismo y son los que aparecerán en la sección de ***Datos del Solicitante*** en ***Actualizar Perfil*** para **Crear Nueva Solicitud** o **Crear Nueva Orden**. Contiene la información personal del solicitante. 
